...
<body style="background-color:white" onload="totalprice()" >
          ...
          <div class="col-md-8 clearfix">
            <div class="shop-menu clearfix pull-right">
              <ul class="nav navbar-nav">     
                ...
                <?php }else{ ?> 
                <li><a   href="loginregister.php"><i class="fa fa-lock"></i> Login</a></li>
                <li><a   href="loginregister2.php"><i class="fa fa-lock"></i> Jadi Seller !</a></li>
              <?php } ?>
              </ul>
            </div>
          </div>
    ...
    <div class="footer-widget">
      <div class="container">
        ...
        <br><br>
        <p align="justify">E-Item menyediakan pelayanan seputar kebutuhan item game anda dengan harga yang murah dan terjamin aman.</p>                 
        </div>
          <div class="col-sm-3">
