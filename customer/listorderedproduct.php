...
<?php 
}elseif ($cur->PAYMENTMETHOD=="Transfer Bank"){
...
<hr/>
 <h4><strong>Order Information</strong></h4>
				...
				<?php
				 $subtot=0;
				  $query = "SELECT * 
						...
						echo '<tr>';  
				  		echo '<td align="left">'. $result->PRODESC.'</td>';
				  		echo '<td align="left"> Rp '. number_format($result->PROPRICE,2).' </td>';
		...
		if ($cur->PAYMENTMETHOD=="Transfer Bank") {
			# code...
			$price = $cur->DELFEE;
		}else{
			$price = 0.00;
		...
		?>
 		...
 		<div class="row">
		  	...
		  	<div class="col-md-6 pull-right">
		  		...
		  		<p align="right">Bank Admin Fee : Rp <?php echo number_format($price,2); ?></p>
